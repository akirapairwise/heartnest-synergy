...
const MoodDisplay = () => {
  ...
  return (
    <>
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden rounded-xl border-none bg-gradient-to-br from-white via-gray-50 to-love-50/30">
